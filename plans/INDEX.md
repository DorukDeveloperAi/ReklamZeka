...
> Damga: `06d08f9fb388` · Kaynak: `plans/*/v*/{MASTER,STATE,CHECKLIST}.md` + `plans/legacy.json`
> Tazelik: `node ~/.claude/skills/plan-organizatoru/scripts/agac.mjs --gate` (damga uyuşmazlığı = bayat INDEX → yeniden türet)

## Ağaç

- **proje** (v2 · SÜRÜYOR · aşama 6/14 · sıradaki: 11-bütçe planlama) — ReklamZeka Meta Reklam İşletim Sistemi `[proje]` `P2`

## Planlar

| plan | kategori | künye (kritiklik/aciliyet · hacim) | üst | sürüm | durum | aşamalar | checklist (açık/kapalı) | son tur |
|---|---|---|---|---|---|---|---|---|
| [proje](proje/v2/MASTER.md) | proje | yüksek/normal · epik (P2) | — | v2 | SÜRÜYOR | 6/14 | 101/161 | — |
...
- Sıradaki aşama: **11 — bütçe planlama** (AÇIK)
- Bekleyen: 11-bütçe planlama ⟵ 09, 10 · 13-eylem valfi ve rutin ⟵ 10–12 · 14-kontrol merkezi ⟵ 07, 09–13
- Hazır komut: `/goal plans/proje/v2/asama-11-butce-planlama.md planını uygula; bitince aynı klasördeki STATE.md ve CHECKLIST.md'yi güncelle; kanıt yollarını STATE.md'ye yaz`
