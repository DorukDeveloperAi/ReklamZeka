...
- **proje** (v1 · SÜRÜYOR · aşama 6/7 · sıradaki: 07-rapor ve pilot) — ReklamZeka MVP `[proje]` `P2`

## Planlar

| plan | kategori | künye (kritiklik/aciliyet · hacim) | üst | sürüm | durum | aşamalar | checklist (açık/kapalı) | son tur |
|---|---|---|---|---|---|---|---|---|
| [proje](proje/v1/MASTER.md) | proje | yüksek/normal · epik (P2) | — | v1 | SÜRÜYOR | 6/7 | 6/26 | 2026-08-06 — rapor-ve-pilot-hazirlik |
...
- Son tur: **2026-08-06 — rapor-ve-pilot-hazirlik** — İmzalı/süreli/iptal edilebilir salt-okunur paylaşım, CSV export, dört operasyon alarmı/runbook'u ve pilot ölçüm motoru kuruldu.
- Sıradaki aşama: **07 — rapor ve pilot** (AÇIK)
- Hazır komut: `/goal plans/proje/v1/asama-07-rapor-ve-pilot.md planını uygula; bitince aynı klasördeki STATE.md ve CHECKLIST.md'yi güncelle; kanıt yollarını STATE.md'ye yaz`
