...
> Damga: `c07e963cf364` · Kaynak: `plans/*/v*/{MASTER,STATE,CHECKLIST}.md` + `plans/legacy.json`
> Tazelik: `node ~/.claude/skills/plan-organizatoru/scripts/agac.mjs --gate` (damga uyuşmazlığı = bayat INDEX → yeniden türet)

## Ağaç

- **proje** (v2 · SÜRÜYOR · aşama 6/14 · sıradaki: 09-kategori ve talimat) — ReklamZeka Meta Reklam İşletim Sistemi `[proje]` `P2`

## Planlar

| plan | kategori | künye (kritiklik/aciliyet · hacim) | üst | sürüm | durum | aşamalar | checklist (açık/kapalı) | son tur |
|---|---|---|---|---|---|---|---|---|
| [proje](proje/v2/MASTER.md) | proje | yüksek/normal · epik (P2) | — | v2 | SÜRÜYOR | 6/14 | 96/150 | — |

## Öncelik sırası (türev — künye: kritiklik × aciliyet)

1. **proje** — yüksek/normal · epik (P2) · hedef: ReklamZeka; Meta portföyünü doğru bağlamda anlayan, kullanıcı
...
- Sıradaki aşama: **09 — kategori ve talimat** (AÇIK)
- Bekleyen: 09-kategori ve talimat ⟵ 08 · 11-bütçe planlama ⟵ 09, 10 · 13-eylem valfi ve rutin ⟵ 10–12 · 14-kontrol merkezi ⟵ 07, 09–13
- Hazır komut: `/goal plans/proje/v2/asama-09-kategori-talimat.md planını uygula; bitince aynı klasördeki STATE.md ve CHECKLIST.md'yi güncelle; kanıt yollarını STATE.md'ye yaz`
