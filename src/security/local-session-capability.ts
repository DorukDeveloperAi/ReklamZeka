...
export const LOCAL_SESSION_RUNTIME_SCOPES: readonly LocalSessionScope[] = Object.freeze([
  ...
  "policy_bundle:draft", "policy_bundle:publish", "policy_bundle:read", "decision_cadence:publish", "experiment_record:mutate", "business_outcome:record", "budget_lab:draft", "budget_lab:read",
