...
export const metaTrustReadinessNotConfiguredResponse = () =>
  error(503, "source_not_configured", "Meta veri kalitesi raporu yerel çalışma alanına henüz bağlanmadı.");
...
export function createMetaTrustReadinessHttpHandler(input: Readonly<{
  ...
  return async (request: Request) => {
    try {
      ...
      return error(503, "source_unavailable", "Meta veri kalitesi raporu güvenli biçimde okunamadı.");
    }
  };
}
