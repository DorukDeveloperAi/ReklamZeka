...
describe("local MCP HTTP bridge", () => {
  it("maps all 18 exact tools to the existing bearer endpoints and never returns coordination identity", async () => {
    ...
    const minimal: Record<string, Record<string, unknown>> = {
      ...
      guidance_effective_preview: { contractVersion: "guidance-agent-tools/1.2.0", expectedCatalogHash: "c".repeat(64),
        accountRef: "account_public", accountGroupRefs: [], objective: null,
