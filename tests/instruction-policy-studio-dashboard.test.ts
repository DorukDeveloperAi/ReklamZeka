...
const impact = { contractVersion: "instruction-policy-impact/1.0.0", impactHash: "d".repeat(64),
  operation: "publish", registryHash: hash, target: { policyRef: policy.policyRef, policyVersion: 1,
    ...
    nonTerminalActionUnits: 0, activeManualLocks: 0 }, historicalImpact: { historicalInboundExceptions: 0, directAppliedContexts: 0,
    ...
    terminalActionUnits: 0, invalidatedTerminalActionUnits: 0 }, invalidationPlan: { registryComponents: 0, contextsNeedingInvalidation: 0 },
