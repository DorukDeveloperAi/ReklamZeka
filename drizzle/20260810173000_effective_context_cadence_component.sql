-- Forward-only expansion: cadence profile facts can selectively invalidate frozen contexts.
...
ALTER TABLE "effective_campaign_context_components" ADD CONSTRAINT "effective_campaign_context_components_type" CHECK ("effective_campaign_context_components"."component_type" in (
  ...
  'business_outcome_evidence', 'cadence_profile'
...
-- These existing public relations remain server-private after the constraint refresh.
