...
CREATE TABLE "local_agent_sessions" (
    ...
    and jsonb_array_length("local_agent_sessions"."allowed_tools") between 1 and 13
    ...
    and "local_agent_sessions"."last_seen_at" < "local_agent_sessions"."expires_at"
...
--> statement-breakpoint
-- Composite session FKs below require this unique index to exist first.
